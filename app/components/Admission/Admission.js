...
const Admission = (props)=>(
  <div>
    ...
    <ul style = {{listStyleType:"none"}}>
      ...
      <li>Getting the Class state to affect the Section state and hence the default payment</li>
      <li>On Submit: Create Student, Add Fees based on class and section, Set Default Student Parameters</li>
    </ul>
  </div>
)
